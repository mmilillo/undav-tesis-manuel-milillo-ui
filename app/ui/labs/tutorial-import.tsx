...
export default function ImportTutorial({ laboratoryName }: { laboratoryName: string}) {
  ...
  return (
    ...
    <pre style={{ backgroundColor: '#f4f4f4', padding: '10px', border: '1px solid #ddd', overflowX: 'auto' }}>
    {`
        'No se dispone del YAML utilizado para este laboratorio, ya que se trata de un laboratorio importado y no de uno creado desde un YAML.'
    `}
